...
<body>
    ...
    <p><button class="btn btn-primary" onclick="myFunction()" >Welcome to Lariox Bank</button></p>
...
function myFunction() {
  ...
  if (x.innerHTML === "") {
    ...
    x.innerHTML = "About Us <br><br> Basic Banking System Website for transferring money online safely<br>Lariox Bank is one of India’s leading private banks and was among the first to receive approval<br> from the Reserve Bank of India (RBI) to set up a private sector bank in 1996.<br><br> Contact Us <br><br>                                           Call us - 0000 1111 222<br>Send an email to contact@lrbank.com"
  }
}
</script>
    ...
    <footer style="background-color: white; color: black;"    class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b><i>Vepuri Dennis Sidney</i></b></p>
    </footer>
